...
sources = [
    ...
    ArchiveSource("https://github.com/eschnett/MPItrampoline/archive/74815f9701f638492565bc4b0256ef1fc03ec93d.tar.gz",
                  "e2f9c246c95bd1fd7952a6d6da07061af8b72c8d10aaca4ad23c2218b5d11329"),
...
if [ -f ${prefix}/lib/mpich/lib/libpmpi.${suffix} ]; then
    cmake \
        ...
        -DMPI_mpi_LIBRARY=${prefix}/lib/mpich/lib/libmpi.${suffix} \
        -DMPI_mpicxx_LIBRARY=${prefix}/lib/mpich/lib/libmpicxx.${suffix} \
        -DMPI_mpifort_LIBRARY=${prefix}/lib/mpich/lib/libmpifort.${suffix} \
        -DMPI_pmpi_LIBRARY=${prefix}/lib/mpich/lib/libpmpi.${suffix} \
